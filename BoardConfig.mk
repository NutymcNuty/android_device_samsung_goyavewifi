...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 5901385728
...
# RIL
BOARD_RIL_CLASS := ../../../device/samsung/goyave3g/ril
# COMMON_GLOBAL_CFLAGS += -DSEC_PRODUCT_FEATURE_RIL_CALL_DUALMODE_CDMAGSM

# Bluetooth
BOARD_HAVE_BLUETOOTH := true
BOARD_HAVE_BLUETOOTH_BCM := true
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/samsung/goyave3g/bluetooth
BOARD_BLUEDROID_VENDOR_CONF := device/samsung/goyave3g/bluetooth/libbt_vndcfg.txt
...
WIFI_DRIVER_NVRAM_PATH := "/system/etc/wifi/nvram_net_DCXO.txt"
WIFI_BAND := 802_11_ABG
BOARD_HAVE_SAMSUNG_WIFI := true

# Hardware rendering
BOARD_EGL_CFG := device/samsung/goyave3g/configs/egl.cfg
